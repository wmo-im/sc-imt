...
. Work with the Secretarriat, Regional Associations and Programmes to support the successful implementation of WIS 2.0 using proven change management practices,
